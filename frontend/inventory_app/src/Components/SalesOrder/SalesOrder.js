              ...
              <tbody>
                <tr className="myform-row">
                  <td className="myform-label">
                    <label htmlFor="name" className="myform-label">
                      Customer Name:
                    </label>
                  </td>
                  <td>
                ...
                <tr className="myform-row">
                  <td className="myform-label">
                    <label htmlFor="email" className="myform-label">
                      Customer Email:
                    </label>
                  </td>
                  <td>
                      ...
                      <tbody>
                          ...
                          <tr key={index}>
                            <td>
                              ...
                              >
                                ...
                                {items.map((item, idx) => (
                                  <option value={item.product_name} key={idx}>
                                    {item.product_name}
                                  </option>
                                ))}
                              </select>
                            ...
                            <td>
                              <button
                                type="button"
                                className="myform-remove-row-button"
                        ...
                        <tr>
                          <td>
                            <div className="pt-2">
                              <button
                                className="myform-add-row-button"
                                onClick={addNewRow}
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 512 512"
                                  className="icon icon-sm text-open fill-azure-blue align-middle"
                                >
                                  ...
                                  <path
                                    fill="#FFF"
                                    d="M378 234H278V134c0-12.2-9.8-22-22-22s-22 9.8-22 22v100H134c-12.2 0-22 9.8-22 22s9.8 22 22 22h100v100c0 12.2 9.8 22 22 22s22-9.8 22-22V256h100c12.2 0 22-9.8 22-22s-9.8-22-22-22z"
                                  ></path>
                                </svg>
                ...
                <tr>
                  {items.length === 0 && (
                    <div className="no-items alert alert-danger">
                      No items Found , Please add some first!
                    </div>
                  )}
                </tr>
                {error !== "" && (
